<template>
  <button
    :class="[
      ...
      'bg-white text-primary-700 hover:bg-primary-50 active:shadow-button-default focus-visible:shadow-button-default',
...
<script lang="ts" setup>
  ...
  export interface IQuaternaryButtonProps {
    text?: string;
    icon?: Component;
    mode?: 'icon' | 'text' | 'both';
  ...
  const props = withDefaults(defineProps<IQuaternaryButtonProps>(), {
    mode: 'text',
    iconPosition: 'left',
    size: '40',
  });
