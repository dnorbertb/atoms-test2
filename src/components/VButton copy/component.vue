...
<script lang="ts" setup>
  ...
  import type { IPrimaryButtonProps } from '@/components/VButton/Primary/component.vue';
  import type { ISecondaryButtonProps } from '@/components/VButton/Secondary/component.vue';
  import type { ITertiaryButtonProps } from '@/components/VButton/Tertiary/component.vue';
  import type { IQuaternaryButtonProps } from '@/components/VButton/Quaternary/component.vue';
